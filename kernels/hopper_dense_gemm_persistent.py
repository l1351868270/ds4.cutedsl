# Adapted from https://github.com/NVIDIA/cutlass/blob/v4.5.0/examples/python/CuTeDSL/cute/hopper/kernel/dense_gemm/dense_gemm_persistent.py
...
.. code-block:: bash
    ...
    python kernels/hopper_dense_gemm_persistent.py                        \
